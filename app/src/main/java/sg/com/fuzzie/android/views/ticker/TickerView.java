package sg.com.fuzzie.android.views.ticker;
...
public class TickerView extends View {
    ...
    private final ValueAnimator animator = ValueAnimator.ofFloat(2f);
    ...
    protected void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        final TickerView.StyledAttributes styledAttributes = new TickerView.StyledAttributes(res);
